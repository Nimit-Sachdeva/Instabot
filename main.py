...
def like_post(insta_username):
    ...
    if post_a_like['meta']['code'] == 200:
        print 'Like krdia ab khush reh !'
    else:
        print 'Your like? Nahi ho paya.I will Try again!'
    ...
    if like_info['meta']['code'] == 200:
        if len(like_info['data']) > 0:
            for user_info in like_info['data']:
                print ("Liked by: %s") % (user_info["full_name"])
        else:
...
def post_a_comment(insta_username):
    ...
    if make_comment['meta']['code'] == 200:
        print "Krdia comment bhi ...ja aish kr!"
    else:
        print "Nahi ho paya comment.Will Try again!"
